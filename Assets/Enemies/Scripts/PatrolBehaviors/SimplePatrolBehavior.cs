...
public class SimplePatrolBehavior : IPatrolable
{
    GameObject _object;
    Transform _transform;
    Vector3[] patrolPoints;
    float segmentMovingTime;
    public SimplePatrolBehavior(GameObject gameObject)
    {
        _object = gameObject;
    ...
    public SimplePatrolBehavior(GameObject gameObject, Vector3[] PatrolPoints, float timeToMoveOnOneSegment)
    {
        _object = gameObject;
        _transform = gameObject.transform;
